...
// NOTE: The Office.onReady block that registered the onWorksheetChanged event handler
// has been moved to taskpane.js to ensure it's active when the task pane is open.
