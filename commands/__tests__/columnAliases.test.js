...
const PREVIOUSLY_MATCHED = {
    ...
    GENDER_ALIASES: ['gender'],
    OUTREACH_ALIASES: ['outreach', 'comments', 'notes', 'comment'],
    HOLD_ALIASES: ['hold'],
    ASSIGNED_ALIASES: ['assigned', 'advisor', 'counselor', 'assigned to'],
    CREATED_BY_ALIASES: ['created by', 'author', 'advisor'],
    GRADE_ALIASES: ['grade', 'course grade', 'grades', 'current grade', 'grade %'],
    ...
    PRIMARY_PHONE_ALIASES: ['primary phone', 'phone', 'phonenumber', 'contact number', 'contact'],
    OTHER_PHONE_ALIASES: ['other phone', 'otherphone', 'alt phone'],
    ...
    LAST_LDA_ALIASES: ['lda', 'last lda', 'last date of attendance'],
    ...
    TITLE_ALIASES: ['assignment title', 'title', 'assignment'],
    DUE_DATE_ALIASES: ['due date', 'deadline'],
    SCORE_ALIASES: ['score', 'points'],
    SUBMISSION_LINK_ALIASES: ['submission link', 'submission', 'submit link'],
    ASSIGNMENT_LINK_ALIASES: ['assignment link', 'assignment url', 'assignment page', 'link'],
    ...
    TAGS_ALIASES: ['tag', 'tags', 'history', 'category', 'type'],
    TIMESTAMP_ALIASES: ['timestamp', 'date', 'time', 'created at'],
    COMMENT_ALIASES: ['comment', 'notes', 'history', 'entry'],
    COMMENT_ID_ALIASES: ['comment id', 'history id', 'entry id', 'commentid'],
};
