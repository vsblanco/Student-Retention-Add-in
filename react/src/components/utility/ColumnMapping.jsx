...
export const COLUMN_ALIASES = {
  ...
  ID: ['Student ID', 'SyStudentID', 'Student Identifier', 'Student Number','Student identifier'],
  Gender: ['Gender'],
...
export const COLUMN_ALIASES_HISTORY = {
  ...
  StudentID: ['Student ID', 'SyStudentID', 'Student Identifier', 'Student Number','Student identifier'],
